find_path(LIBVRPN_INCLUDE_DIR vrpn_Tracker.h
          HINTS $ENV{G}/src/vrpn/7.30/vrpn $ENV{G}/src/vrpn/7.15/vrpn $ENV{VRPN_INCLUDE_DIR} $ENV{G}/install_linux/include $ENV{CAVE}/include/vrpn ${VRPN_INCLUDE_DIR})

find_library(LIBVRPN_OPT_LIBRARY NAMES libvrpn.a vrpn.lib vrpn
          HINTS $ENV{G}/src/vrpn/7.30/vrpn/build/${GBUILDSTR}/Release $ENV{G}/src/vrpn/7.15/vrpn/build/client/${GBUILDSTR}/Release $ENV{VRPN_LIB_DIR} $ENV{G}/install_linux/lib $ENV{CAVE}/lib ${VRPN_LIB_DIR})

find_library(LIBVRPN_DEBUG_LIBRARY NAMES libvrpn.a vrpn.lib vrpn
          HINTS $ENV{G}/src/vrpn/7.30/vrpn/build/${GBUILDSTR}/Debug $ENV{G}/src/vrpn/7.15/vrpn/build/client/${GBUILDSTR}/Debug $ENV{VRPN_LIB_DIR} $ENV{G}/install_linux/lib $ENV{CAVE}/lib ${VRPN_LIB_DIR})
