...
#ifndef VRG3D_SDLWINDOW_H
#define VRG3D_SDLWINDOW_H
...
public:
    virtual void myReallyMakeCurrent() const;
...
public:
    ...
    virtual void getRelativeMouseState(Vector2& p, G3D::uint8& mouseButtons) const;
