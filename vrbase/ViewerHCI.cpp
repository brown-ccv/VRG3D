...
void
ViewerHCI::trackballOn(VRG3D::EventRef e)
{
    _lastIntersectionPt = Vector3::inf();
}

void
ViewerHCI::trackballMove(VRG3D::EventRef e)
{
...
void
ViewerHCI::trackballOff(VRG3D::EventRef e)
{
}


void
ViewerHCI::toggleRocking(VRG3D::EventRef e)
{
  _rocking = !_rocking;
  if (_rocking) {
    _lastRotTime = -1;
...
void
ViewerHCI::panLeft(VRG3D::EventRef e)
{
...
void
ViewerHCI::panRight(VRG3D::EventRef e)
{
  CoordinateFrame t(Vector3(-_panAmt,0,0));
  _gfxMgr->setRoomToVirtualSpaceFrame(_gfxMgr->getRoomToVirtualSpaceFrame() * t);
}
...
void
ViewerHCI::panUp(VRG3D::EventRef e)
{
...
void
ViewerHCI::panDown(VRG3D::EventRef e)
{
  CoordinateFrame t(Vector3(0,_panAmt,0));
  _gfxMgr->setRoomToVirtualSpaceFrame(_gfxMgr->getRoomToVirtualSpaceFrame() * t);
}
...
void
ViewerHCI::dollyIn(VRG3D::EventRef e)
{
...
void
ViewerHCI::dollyOut(VRG3D::EventRef e)
{
  CoordinateFrame t(Vector3(0,0,_panAmt));
  _gfxMgr->setRoomToVirtualSpaceFrame(_gfxMgr->getRoomToVirtualSpaceFrame() * t);
}
...
void
ViewerHCI::scaleUp(VRG3D::EventRef e)
{
  _gfxMgr->setRoomToVirtualSpaceScale(0.95 * _gfxMgr->getRoomToVirtualSpaceScale());
}

void
ViewerHCI::scaleDown(VRG3D::EventRef e)
{
  _gfxMgr->setRoomToVirtualSpaceScale(1.05 * _gfxMgr->getRoomToVirtualSpaceScale());
}

void
ViewerHCI::speedUpRocking(VRG3D::EventRef e)
{
  _rotAngularVel += 0.05;
}

void
ViewerHCI::slowDownRocking(VRG3D::EventRef e)
{
  _rotAngularVel -= 0.05;
}

void
ViewerHCI::incRockingAngle(VRG3D::EventRef e)
{
  _rockingAngle += 0.05;
}

void
ViewerHCI::decRockingAngle(VRG3D::EventRef e)
{
  _rockingAngle -= 0.05;
}
