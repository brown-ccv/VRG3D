...
#   elif defined(G3D_OSX)
        return CocoaWindow::primaryDisplaySize();
#   else
...
#   elif defined(G3D_OSX)
        return CocoaWindow::virtualDisplaySize();
#   else
...
#   elif defined(G3D_OSX)
        return CocoaWindow::primaryDisplayWindowSize();
#   else
...
#   elif defined(G3D_OSX)
        return CocoaWindow::numDisplays();
#   else
